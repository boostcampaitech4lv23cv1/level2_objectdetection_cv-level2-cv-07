...
train_pipeline = [
    ...
    dict(type='Resize', img_scale=(640,640), keep_ratio=True), # 이미지 size!
...
evaluation = dict(save_best="bbox_mAP_50",interval=0, metric='bbox', classwise=True)